...
use Shallowr\WeatherGaode\Exception\InvalidArgumentException;
use Shallowr\WeatherGaode\WeatherGaode;

class WeatherGaodeTest extends TestCase
{
    // 检查 $type 参数
    public function testGetWeatherWithInvalidType()
    {
        $w = new WeatherGaode('mock-key');
    ...
    public function testGetWeather()
    {
        ...
        $w = \Mockery::mock(WeatherGaode::class, ['mock-key'])->makePartial();
